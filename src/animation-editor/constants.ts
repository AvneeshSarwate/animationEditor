...
export const TRACK_BG_COLOR = '#1a1a2e'
export const TRACK_BG_COLOR_ALT = '#16213e' // If you want alternating later
...
// Colors - Time ribbon
export const RIBBON_BG_COLOR = '#2d2d44'
export const RIBBON_VIEWPORT_COLOR = '#7b2cbf'
export const RIBBON_HANDLE_COLOR = '#e0aaff'
export const RIBBON_HANDLE_WIDTH = 8

// Colors - Time ticks
export const TICK_COLOR = '#888'
export const TICK_LABEL_COLOR = '#aaa'
export const TICK_HEIGHT = 8

// Colors - Name column
export const NAME_BG_COLOR = '#0f0f23'
export const NAME_TEXT_COLOR = '#e0e0e0'
...
export const LANE_LABEL_WIDTH = 60
